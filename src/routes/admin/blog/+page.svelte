...
<div class="sm:flex sm:items-center">
	<div class="sm:flex-auto">
		<h1 class="font-serif text-3xl font-bold tracking-wide text-black uppercase">Blog</h1>
		<p class="mt-2 text-sm text-gray-500">Manage your blog articles and publications.</p>
	</div>
						...
						{:else}
							{#each posts as post}
								<tr>
									...
									>
										<a href="/blog/{post.slug}" target="_blank" class="hover:underline"
											>{post.title}</a
										>
									</td>
									...
									>
										<a href="/admin/blog/{post.id}" class="font-medium text-black hover:underline"
