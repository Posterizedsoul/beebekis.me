...
export const GET = async () => {
	...
	// 1. Memories
	const memoryFiles = import.meta.glob('/src/lib/assets/Memories/*/info.md', {
		query: '?raw',
		import: 'default',
		eager: true
	});
	const memoryImages = import.meta.glob(
		'/src/lib/assets/Memories/**/*.{jpg,jpeg,png,webp,avif,gif}',
	...
	const diaryImages = import.meta.glob('/src/lib/diary/**/*.{jpg,jpeg,png,webp,avif,gif}', {
		query: '?url',
		import: 'default',
		eager: true
	});
	...
	// 3. Blog
	const blogFiles = import.meta.glob('/src/lib/posts/**/+page.md', {
		query: '?raw',
		import: 'default',
		eager: true
	});
	const blogImages = import.meta.glob('/src/lib/posts/**/*.{jpg,jpeg,png,webp,avif,gif}', {
		query: '?url',
		import: 'default',
		eager: true
	});
